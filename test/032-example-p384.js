...
// var suite = Suite.create(mocha.suite,'Running the example - p384');
//
// suite.timeout(60000);
//
...
//     scope.alice   = new scope.EC('p384');
//     scope.bob     = new scope.EC('p384');
//     scope.charlie = new scope.EC('p384');
...
//     assert.equal(scope.alice.kp.pri.data.length,48);
//     assert.equal(scope.bob.kp.pri.data.length,48);
//     assert.equal(scope.charlie.kp.pri.data.length,48);
//     done();
//   }));
//
