...
EC.prototype.sign = function( data, key ) {
  ...
  return Buffer.concat([sig.r.toArrayLike(Buffer,'be',this.prilen),sig.s.toArrayLike(Buffer,'be',this.prilen)]);
};
...
EC.prototype.verify = function( data, signature, key ) {
  ...
  return this.ec.verify(msg,{r:sig.slice(0,this.prilen),s:sig.slice(this.prilen,this.prilen*2)},pub);
};
